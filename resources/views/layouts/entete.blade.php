                ...
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('employer.ajout') }}">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les employer</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('employer.lister') }}">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister les employer </span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples1">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('formateur.ajout') }}">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les formateur </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('formateur.lister') }}">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister Formateur </span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples2">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('formation.ajout') }}">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les formations </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('formation.lister') }}">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister Formations </span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples3">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('sessions.ajout') }}">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les sessions </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('sessions.lister') }}">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister les sessions </span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples4">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('evaluations.ajout') }}">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les evaluations </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('evaluations.lister') }}">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister les evaluations</span>
                                    </a>
                                </li>
                            ...
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="../examples/pages/pricing.html">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les ressources </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="../examples/pages/rtl.html">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister les ressources </span>
                                    </a>
                                </li>
                        ...
                        <div class="collapse" id="pagesExamples6">
                            <ul class="nav">
                                <li class="nav-item ">
                                    ...
                                    <a class="nav-link" href="../examples/pages/pricing.html">
                                        <span class="sidebar-mini"> P </span>
                                        <span class="sidebar-normal"> Ajouter les salles </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="../examples/pages/rtl.html">
                                        <span class="sidebar-mini"> RS </span>
                                        <span class="sidebar-normal"> Lister les salles </span>
                                    </a>
                                </li>
